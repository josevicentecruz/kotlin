...
public class IrJsCodegenInlineES6TestGenerated extends AbstractIrJsCodegenInlineES6Test {
    ...
    public static class InlineClasses extends AbstractIrJsCodegenInlineES6Test {
        ...
        @TestDataPath("$PROJECT_ROOT")
        @RunWith(JUnit3RunnerWithInners.class)
        public static class UnboxLambdaArgument extends AbstractIrJsCodegenInlineES6Test {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest0(this::doTest, TargetBackend.JS_IR_ES6, testDataFilePath);
            }

            public void testAllFilesPresentInUnboxLambdaArgument() throws Exception {
                KotlinTestUtils.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/codegen/boxInline/inlineClasses/unboxLambdaArgument"), Pattern.compile("^(.+)\\.kt$"), null, TargetBackend.JS_IR_ES6, true);
            }
