...
public class JvmIrAgainstOldBoxInlineTestGenerated extends AbstractJvmIrAgainstOldBoxInlineTest {
    ...
    public static class InlineClasses extends AbstractJvmIrAgainstOldBoxInlineTest {
        ...
        @TestDataPath("$PROJECT_ROOT")
        @RunWith(JUnit3RunnerWithInners.class)
        public static class UnboxLambdaArgument extends AbstractJvmIrAgainstOldBoxInlineTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTestWithCustomIgnoreDirective(this::doTest, TargetBackend.JVM_MULTI_MODULE_IR_AGAINST_OLD, testDataFilePath, "// IGNORE_BACKEND_MULTI_MODULE: ");
            }

            public void testAllFilesPresentInUnboxLambdaArgument() throws Exception {
                KotlinTestUtils.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/codegen/boxInline/inlineClasses/unboxLambdaArgument"), Pattern.compile("^(.+)\\.kt$"), null, TargetBackend.JVM_MULTI_MODULE_IR_AGAINST_OLD, true);
            }
