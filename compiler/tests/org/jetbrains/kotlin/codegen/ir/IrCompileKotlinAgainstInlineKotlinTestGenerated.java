...
public class IrCompileKotlinAgainstInlineKotlinTestGenerated extends AbstractIrCompileKotlinAgainstInlineKotlinTest {
    ...
    public static class InlineClasses extends AbstractIrCompileKotlinAgainstInlineKotlinTest {
        ...
        @TestDataPath("$PROJECT_ROOT")
        @RunWith(JUnit3RunnerWithInners.class)
        public static class UnboxLambdaArgument extends AbstractIrCompileKotlinAgainstInlineKotlinTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTestWithCustomIgnoreDirective(this::doTest, TargetBackend.JVM_IR, testDataFilePath, "// IGNORE_BACKEND_MULTI_MODULE: ");
            }

            public void testAllFilesPresentInUnboxLambdaArgument() throws Exception {
                KotlinTestUtils.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/codegen/boxInline/inlineClasses/unboxLambdaArgument"), Pattern.compile("^(.+)\\.kt$"), null, TargetBackend.JVM_IR, true);
            }
